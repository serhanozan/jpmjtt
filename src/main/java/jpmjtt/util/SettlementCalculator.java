...
public class SettlementCalculator {
	...
	public static HashMap<LocalDate, BigDecimal> calculateDailyIncomingSettlements(List<Instruction> instructions){
	...
	public static HashMap<LocalDate, BigDecimal> calculateDailyOutgoingSettlements(List<Instruction> instructions){
	...
	private static HashMap<LocalDate, BigDecimal> calculateDailySettlements(List<Instruction> instructions){
		HashMap<LocalDate, BigDecimal> dailyIncomingSettlements = new HashMap<LocalDate, BigDecimal>();
